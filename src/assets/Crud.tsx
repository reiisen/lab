    ...
    <div class="flex flex-1 flex-row py-10 lg:w-3/4 md:w-3/4">
      <Tabs aria-label="Main navigation" class="tabs">
        <Tabs.List class="tabs__list">
          ...
          <Tabs.Trigger class="tabs__trigger" value="read">
            Read
          </Tabs.Trigger>
          <Tabs.Trigger class="tabs__trigger" value="update">
            Update
          </Tabs.Trigger>
          <Tabs.Trigger class="tabs__trigger" value="delete">
            Delete
          </Tabs.Trigger>
        ...
        <Tabs.Content class="tabs__content" value="create">
          <Show
            when={labData.state === "ready" && subjectData.state === "ready"}
          >
      ...
      <button
        onClick={() =>
          createCourse({
            ...
            day: dayIndex.get(day().toLowerCase())! + 1,
            length: parseInt(length()),
            timeslot: timeIndex.get(timeslot())! + 7,
          })
        }
        class="w-fit p-4"
      >
...
const CrudUpdate: Component = () => {
  return <div class={crudContentStyle}>hi</div>;
};
